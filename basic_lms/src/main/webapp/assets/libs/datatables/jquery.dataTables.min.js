...
(function (f) {
  ...
  function Mb(a, b) {
    ...
    for (var h, g = q.ext.type.order[c.sType + "-pre"], k = 0, f = a.aoData.length; k < f; k++) if (((c = a.aoData[k]), c._aSortData || (c._aSortData = []), !c._aSortData[b] || d)) (h = d ? e[k] : I(a, k, b, "sort")), (c._aSortData[b] = g ? g(h) : h);
  }
  function Ba(a) {
  ...
  var ib = function (a) {
    ...
    return "string" === typeof a ? a.replace(/</g, "<i class='material-icons'>navigate_before</i>").replace(/>/g, "<i class='material-icons'>navigate_next</i>").replace(/"/g, "&quot;") : a;
